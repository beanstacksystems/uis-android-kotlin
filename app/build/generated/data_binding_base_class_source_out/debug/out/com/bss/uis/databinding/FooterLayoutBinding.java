...
public final class FooterLayoutBinding implements ViewBinding {
  ...
  private FooterLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView versiontextview) {
  ...
  public static FooterLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FooterLayoutBinding((LinearLayout) rootView, versiontextview);
    }
